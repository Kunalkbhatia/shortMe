...
function Landing() {
  return (
    <div className="p-11 space-y-20">
      <div className="flex justify-between items-center">
        <div className="font-bold text-4xl">Short Me</div>
        <Link
          href="/sign-in"
          className="font-semibold bg-primaryButton text-white text-xl p-4 rounded-full"
        >
          Get Started
        </Link>
      </div>
      <div className="flex flex-col gap-5 items-center bg-secondaryBg py-10 rounded-full">
        <div className="bg-white p-3 rounded-full font-semibold">
          🔥 Introducing ShortMe
        </div>
        <div className="font-extrabold text-5xl text-center w-[700px]">
          URL shortening amplified, where insights meet impact.
        </div>
        <div className="font-semibold text-gray-500 w-[600px] text-center">
      ...
      <div className="flex flex-col gap-8 items-center bg-secondaryBg py-10 rounded-full">
        <div className="bg-white p-3 rounded-full font-semibold">
          🔥 The Problem
        </div>
        <div className="font-extrabold text-5xl text-center w-[700px]">
      ...
      <div className="flex flex-col items-center gap-10">
        ...
        <div className="font-extrabold text-4xl text-center w-[700px]">
      ...
      <div className="flex justify-around gap-5 items-center bg-secondaryBg py-10 rounded-full">
        <div>
